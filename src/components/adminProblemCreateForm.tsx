...
type AdminProblemCreaeProps={
  problemInput: ProblemInputType,
  setProblemInput: React.Dispatch<React.SetStateAction<ProblemInputType>>

}
const AdminProblemCreateForm:React.FC<AdminProblemCreaeProps> = ({problemInput, setProblemInput}) => {
  return (
    <div>
        <Form.Root className="w-[260px]">
<div className='text-white text-xl font-bold font-mono mt-16'>CREATE NEW PROBLEM</div>
...
export default AdminProblemCreateForm;